...
function g(n, l, u, i, t) {
    ...
    n: if ("style" === l)
        if ("string" == typeof u) n.style.cssText = u;
            ...
            if (u)
                for (l in u) i && u[l] === i[l] || b(n.style, l, u[l])
        }
...
function O(l, u, i, t, r, o, f, e) {
    ...
    if (null === d) y === p || e && l.data === p || (l.data = p);
        ...
        else if (_ = u.props.children, H(l, Array.isArray(_) ? _ : [_], u, i, t, r && "foreignObject" !== d, o, f, o ? o[0] : i.__k && A(i, 0), e), null != o)
...
export {
    x as Component, _ as Fragment, F as cloneElement, G as createContext, y as createElement, d as createRef, y as h, E as hydrate, i as isValidElement, l as options, D as render, j as toChildArray
};
