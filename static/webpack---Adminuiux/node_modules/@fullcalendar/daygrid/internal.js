import {
    ...
    diffWeeks,
    injectStyles
} from '@fullcalendar/core/internal.js';
import {
    createRef,
    createElement,
    Fragment
} from '@fullcalendar/core/preact.js';
...
class TableCell extends DateComponent {
    ...
    render() {
        ...
        return (createElement(DayCellContainer, {
            ...
            (props.showDayNumber || hasCustomDayCellContent(options) || props.forceDayTop) ? (createElement("div", {
        ...
        if (framePositions) {
            for (let seg of segs) {
                ...
                nodes.push(createElement("div", {
                    ...
                    createElement(BgEvent, Object.assign({
                        seg: seg
                    }, getSegMeta(seg, todayRange))) :
                    renderFill(fillType)));
            }
...
export {
    DayTableView as DayGridView, DayTable, DayTableSlicer, Table, TableDateProfileGenerator, TableRows, TableView, buildDayTableModel, buildDayTableRenderRange
};