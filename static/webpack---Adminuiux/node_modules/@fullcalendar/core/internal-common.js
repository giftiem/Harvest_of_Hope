...
class DayHeader extends BaseComponent {
    ...
    render() {
        ...
        return (createElement(NowTimer, {
            ...
            dates.map((date) => (datesRepDistinctDays ? (createElement(TableDateCell, {
...
class StandardEvent extends BaseComponent {
    render() {
        ...
        return (createElement(EventContainer, Object.assign({}, props /* includes elRef */ , {
            ...
            timeText: timeText
        }), (InnerContent, eventContentArg) => (createElement(Fragment, null,
            createElement(InnerContent, {
                elTag: "div",
    ...
    render() {
        ...
        return (createElement(ViewContextType.Consumer, null, (context) => {
            ...
            return (createElement(Fragment, null,
                Boolean(props.moreCnt) && (createElement(ContentContainer, {
                    elTag: props.elTag || 'a',
