...
! function(e, t) {
    ...
    Element.prototype.matches || (Element.prototype.matches = Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector), Element.prototype.closest || (Element.prototype.closest = function(e) {
        ...
        function() {
            ...
            if (e.classList.add("c1", "c2"), !e.classList.contains("c2")) {
                var t = function $c(e) {
                    var $c = DOMTokenList.prototype[e];
                    DOMTokenList.prototype[e] = function(e) {
                        var t, n = arguments.length;
                        for (t = 0; t < n; t++) e = arguments[t], $c.call(this, e)
                    }
                };
                t("add"), t("remove")
            }
    ...
    V.RegisterPlugins = function(e) {
        ...
        function c(e) {
            ...
            for (t in e)
                if (Object.prototype.hasOwnProperty.call(e, t)) {
                    var n = t.match(b),
                        r = null;
                    "style" === t && C.opts.htmlAllowedStyleProps.length && (r = e[t].match(L)), n && r ? e[t] = E(r.join(";")) : n && ("style" !== t || r) || delete e[t]
                }
        ...
        function f(e, t, n) {
            var r = e = function i(e) {
                ...
                o = null;
            return C.opts.fullPage && (r = C.html.extractNode(e, "body") || (0 <= e.indexOf("<body") ? "" : e), n && (o = C.html.extractNode(e, "head") || "")), r = d(r, t), o && (o = d(o, t)),
                function a(e) {
                    return e = (e = (e = e.replace(/\[FROALA\.EDITOR\.SCRIPT ([\d]*)\]/gi, function(e, t) {
                        ...
                        if (0 <= C.opts.htmlRemoveTags.indexOf("noscript")) return "";
        ...
        function h(e) {
            for (var t = C.node.contents(e), n = 0; n < t.length; n++) t[n].nodeType !== Node.TEXT_NODE && h(t[n]);
            ! function g(n) {
                if ("SPAN" === n.tagName && 0 <= (n.getAttribute("class") || "").indexOf("fr-marker")) return !1;
                if ("PRE" === n.tagName && function u(e) {
                        var t = e.innerHTML;
                        0 <= t.indexOf("\n") && (e.innerHTML = t.replace(/\n/g, "<br>"))
                    }(n), n.nodeType === Node.ELEMENT_NODE && (n.getAttribute("data-fr-src") && 0 !== n.getAttribute("data-fr-src").indexOf("blob:") && n.setAttribute("data-fr-src", C.helpers.sanitizeURL(y(n.getAttribute("data-fr-src")))), n.getAttribute("href") && n.setAttribute("href", C.helpers.sanitizeURL(y(n.getAttribute("href")))), n.getAttribute("src") && n.setAttribute("src", C.helpers.sanitizeURL(y(n.getAttribute("src")))), n.getAttribute("srcdoc") && n.setAttribute("srcdoc", C.clean.html(n.getAttribute("srcdoc"))), 0 <= ["TABLE", "TBODY", "TFOOT", "TR"].indexOf(n.tagName) && (n.innerHTML = n.innerHTML.trim())), !C.opts.pasteAllowLocalImages && n.nodeType === Node.ELEMENT_NODE && "IMG" === n.tagName && n.getAttribute("data-fr-src") && 0 === n.getAttribute("data-fr-src").indexOf("file://")) return n.parentNode.removeChild(n), !1;
                if (n.nodeType === Node.ELEMENT_NODE && V.HTML5Map[n.tagName] && "" === C.node.attributes(n)) {
                    ...
                    n.insertAdjacentHTML("beforebegin", t), (n = n.previousSibling).parentNode.removeChild(n.nextSibling)
                }
                    ...
                    if (n.tagName && n.tagName.match(v)) {
                        if ("STYLE" == n.tagName && C.helpers.isMac()) {
                            var r, o = n.innerHTML.trim(),
                                i = [],
                                a = /{([^}]+)}/g;
                            for (o = o.replace(/\/\*[\s\S]*?\*\/|([^\\:]|^)\/\/.*|<!--[\s\S]*?-->$/, ""); r = a.exec(o);) i.push(r[1]);
                            for (var s = function s(t) {
                                    ...
                                    0 == !/^[a-z_-][a-z\d_-]*$/i.test(e) && n.parentNode.querySelectorAll(e).forEach(function(e) {
                                        e.removeAttribute("class"), e.setAttribute("style", i[t])
                                    }), o = o.substring(o.indexOf("}") + 1)
                                }, l = 0; - 1 != o.indexOf("{"); l++) s(l)
                        }
                        n.parentNode.removeChild(n)
                    } else if (n.tagName && !n.tagName.match(m)) "svg" === n.tagName ? n.parentNode.removeChild(n) : C.browser.safari && "path" === n.tagName && n.parentNode && "svg" === n.parentNode.tagName || (n.outerHTML = n.innerHTML);
                else {
                    var c = n.attributes;
                    if (c)
                        for (var d = c.length - 1; 0 <= d; d--) {
                            var f = c[d],
                                ...
                                h = null;
                            "style" === f.nodeName && C.opts.htmlAllowedStyleProps.length && (h = f.value.match(L)), p && h ? f.value = E(h.join(";")) : p && ("style" !== f.nodeName || h) || n.removeAttribute(f.nodeName)
                        }
        ...
        return {
            _init: function e() {
                C.opts.fullPage && p.merge(C.opts.htmlAllowedTags, ["head", "title", "style", "link", "base", "body", "html", "meta"])
            },
            html: function u(e, t, n, r) {
                void 0 === t && (t = []), void 0 === n && (n = []), void 0 === r && (r = !1);
                var o, i = p.merge([], C.opts.htmlAllowedTags);
                for (o = 0; o < t.length; o++) 0 <= i.indexOf(t[o]) && i.splice(i.indexOf(t[o]), 1);
                var a = p.merge([], C.opts.htmlAllowedAttrs);
                for (o = 0; o < n.length; o++) 0 <= a.indexOf(n[o]) && a.splice(a.indexOf(n[o]), 1);
                return a.push("data-fr-.*"), a.push("fr-.*"), m = new RegExp("^".concat(i.join("$|^"), "$"), "gi"), b = new RegExp("^".concat(a.join("$|^"), "$"), "gi"), v = new RegExp("^".concat(C.opts.htmlRemoveTags.join("$|^"), "$"), "gi"), L = C.opts.htmlAllowedStyleProps.length ? new RegExp("((^|;|\\s)".concat(C.opts.htmlAllowedStyleProps.join(":.+?(?=;|$))|((^|;|\\s)"), ":.+?(?=(;)|$))"), "gi") : null, e = f(e, h, !0), "undefined" != typeof C.opts.DOMPurify && (e = C.opts.DOMPurify.sanitize(e, {
            ...
            toHTML5: function r() {
                ...
                if (e.length) {
                    ...
                    for (var n = 0; n < e.length; n++) "" === C.node.attributes(e[n]) && p(e[n]).replaceWith("<".concat(V.HTML5Map[e[n].tagName], ">").concat(e[n].innerHTML, "</").concat(V.HTML5Map[e[n].tagName], ">"));
                    ...
                    for (var e = C.el.querySelectorAll("tr"), t = 0, n = 0; n < e.length; n++) {
                        ...
                        if (!1 !== i && 0 !== o.length) {
                            ...
                            if (1 === o.length && "TH" === o[0].tagName && t) t--;
                                ...
                                var l = s;
                                l.firstChild.nodeType === Node.ELEMENT_NODE && "THEAD" === l.firstChild.tagName ? l = l.firstChild : "THEAD" !== l.tagName && (l = C.doc.createElement("THEAD"), s.insertBefore(l, s.firstChild)), l.appendChild(e[n])
                            }
                        }
                    }
                }(),
                function s() {
                    for (var e = C.$el.find("table[style]"), t = 0; t < e.length; t++) {
                        var n = p(e[t]);
                        n.attr("style").indexOf("width") < 0 && n.css("width", "100%")
                    }
                    for (var r = C.$el.find("td[width]"), o = 0; o < r.length; o++) {
                        var i = p(r[o]),
                            a = i.attr("width");
                        a && (i.css("width", a), i.removeAttr("width"))
                    }
                }()
            },
            lists: function g() {
                ...
                function a() {
                    for (var e = C.el.querySelectorAll("ul, ol"), t = 0; t < e.length; t++)
                        for (var n = C.node.contents(e[t]), r = null, o = n.length - 1; 0 <= o; o--) !n[o].tagName && C.opts.htmlUntouched || "LI" === n[o].tagName || "UL" == n[o].tagName || "OL" == n[o].tagName ? r = null : "BR" == n[o].tagName ? p(n[o]).remove() : (r || (r = p(C.doc.createElement("LI"))).insertBefore(n[o]), r.prepend(n[o]))
                }(),
                function l() {
                    var e, t, n;
                    do {
                ...
                function o() {
                    for (var e = C.el.querySelectorAll("ul > ul, ol > ol, ul > ol, ol > ul"), t = 0; t < e.length; t++) {
                        var n = e[t],
                            r = n.previousSibling;
                        r && ("LI" === r.tagName ? r.appendChild(n) : p(n).wrap("<li></li>"))
                    }
                }(),
                function c() {
                ...
                function d() {
                    for (var e = C.el.querySelectorAll("li > ul, li > ol"), t = 0; t < e.length; t++) {
                        var n = e[t];
                        if (C.node.isFirstSibling(n) && "none" != n.parentNode.style.listStyleType) p(n).before("<br/>");
                            ...
                            r && "BR" !== r.tagName && p(n.previousSibling).remove()
                        }
                    }
                }(),
                function n() {
                    for (var e = C.el.querySelectorAll("li:empty"), t = 0; t < e.length; t++) p(e[t]).remove()
                }(),
                function f() {
                    for (var e = C.el.querySelectorAll("ul, ol"), t = 0; t < e.length; t++)
                        for (var n = e[t], r = C.node.contents(n), o = 1; o < r.length; o++) {
                            var i = r[o],
                                a = C.node.contents(i),
                                s = i.querySelectorAll("ul, ol");
                            if (0 < s.length && 1 == a.length && a[0].nodeType === Node.ELEMENT_NODE) {
                                var l = s[0];
                                r[o - 1].append(l), i.remove()
                            }
                        }
                }()
            },
    ...
    V.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"), V.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())", V.LinkRegExTLD = "((".concat(V.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"), V.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat(V.LinkRegExCommon, ")"), V.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat(V.LinkRegExCommon, ")"), V.LinkRegExWWW = "(www\\.".concat(V.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"), V.LinkRegEx = "(".concat(V.LinkRegExTLD, "|").concat(V.LinkRegExHTTP, "|").concat(V.LinkRegExWWW, "|").concat(V.LinkRegExAuth, ")").concat(V.LinkRegExEnd), V.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], V.MAIL_REGEX = /.+@.+\..+/i, V.MODULES.helpers = function(i) {
        ...
        return {
            ...
            getSafariVersion: function p() {
                var e = navigator.userAgent;
                if (-1 !== e.indexOf("Safari")) {
                    var t = e.match(/Version\/(\d+\.\d+)/);
            ...
            sanitizeURL: function b(e) {
                return i.opts.DOMPurify && (e = i.opts.DOMPurify.sanitize(e, {
                    ADD_TAGS: i.opts.htmlAllowedTags,
                    ALLOW_UNKNOWN_PROTOCOLS: !0,
                    ALLOWED_URI_REGEXP: /^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp|xxx):|[^a-z]|[a-z+.]+(?:[^a-z+.\-:]|$))/i
                })), e = e.replace(/\son\w+='[^']*'/g, ""), /^(https?:|ftps?:|)\/\//i.test(e) ? e : /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(e) ? e : new RegExp("^(".concat(V.LinkProtocols.join("|"), "):"), "i").test(e) ? e : e = encodeURIComponent(e).replace(/%23/g, "#").replace(/%2F/g, "/").replace(/%25/g, "%").replace(/mailto%3A/gi, "mailto:").replace(/file%3A/gi, "file:").replace(/sms%3A/gi, "sms:").replace(/tel%3A/gi, "tel:").replace(/notes%3A/gi, "notes:").replace(/data%3Aimage/gi, "data:image").replace(/blob%3A/gi, "blob:").replace(/%3A(\d)/gi, ":$1").replace(/webkit-fake-url%3A/gi, "webkit-fake-url:").replace(/%3F/g, "?").replace(/%3D/g, "=").replace(/%26/g, "&").replace(/&amp;/g, "&").replace(/%2C/g, ",").replace(/%3B/g, ";").replace(/%2B/g, "+").replace(/%40/g, "@").replace(/%5B/g, "[").replace(/%5D/g, "]").replace(/%7B/g, "{").replace(/%7D/g, "}").replace(/%[0-1]+[0-9]+|%[0-1]+[A-F]+/g, "")
            },
            isArray: function L(e) {
                return e && !Object.prototype.propertyIsEnumerable.call(e, "length") && "object" === x(e) && "number" == typeof e.length
            },
        ...
        function n(e, t) {
            if (!(a.markdown && a.markdown.isEnabled() && ("bold" === e || "italic" === e || "underline" === e) || a.opts.trackChangesEnabled && "markdown" === e) && !1 !== a.events.trigger("commands.before", s.merge([e], t || []))) {
                var n = V.COMMANDS[e] && V.COMMANDS[e].callback || i[e],
                    r = !0,
                    o = !1;
                V.COMMANDS[e] && ("undefined" != typeof V.COMMANDS[e].focus && (r = V.COMMANDS[e].focus), "undefined" != typeof V.COMMANDS[e].accessibilityFocus && (o = V.COMMANDS[e].accessibilityFocus)), (!a.core.hasFocus() && r || !a.core.hasFocus() && o && a.accessibility.hasFocus()) && (a.el.focus({
                    preventScroll: !0
                }), a.events.trigger("focus")), V.COMMANDS[e] && !1 !== V.COMMANDS[e].undo && (a.$el.find(".fr-marker").length && (a.events.disableBlur(), a.selection.restore()), a.undo.saveStep()), n && n.apply(a, s.merge([e], t || [])), a.events.trigger("commands.after", s.merge([e], t || [])), V.COMMANDS[e] && !1 !== V.COMMANDS[e].undo && a.undo.saveStep()
            }
        }
        ...
        return {
            _startEnter: function S(e) {
                ...
                if (v.node.isEmpty(n, !0) && r) {
                    for (var a = "", s = "", l = e.parentNode; !v.node.isList(l) && l.parentNode && ("LI" !== l.parentNode.tagName || l.parentNode === n);) - 1 < ["OL", "LI", "UL"].indexOf(l.tagName) && (a = v.node.openTagString(l) + a, s += v.node.closeTagString(l)), l = l.parentNode;
                    ...
                    f = f.replace(/<span id="fr-break"><\/span>/g, c), b(l).replaceWith(f), v.$el.find("li:empty").remove(), v.$el.find("li > p > span:empty").length && v.$el.find("li > p > span:empty")[0].parentNode.parentNode.remove()
                    ...
                    b(n).remove()
                } else(t = E(n)).parentNode && "LI" === t.parentNode.tagName ? r ? b(t.parentNode).before("".concat(v.node.openTagString(n) + V.MARKERS, "<br></li>")) : b(t.parentNode).after("".concat(v.node.openTagString(n) + V.MARKERS, "<br></li>")) : i ? b(t).before("<".concat(i, ">").concat(V.MARKERS, "<br></").concat(i, ">")) : b(t).before("".concat(V.MARKERS, "<br>")), b(n).remove()
            },
            ...
            _backspace: function d(e) {
                ...
                if (n) {
                    ...
                    r.length && "BR" === r[r.length - 1].tagName && b(r[r.length - 1]).remove(), b(t).find(v.html.blockTagsQuery()).not("ol, ul, table").each(function() {
            ...
            _del: function f(e) {
                var t, n = L(e),
                    r = n.nextSibling;
                if (r) {
                    (t = v.node.contents(r)).length && "BR" === t[0].tagName && b(t[0]).remove(), b(r).find(v.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                    ...
                    if (s = s.nextSibling, v.node.isBlock(s)) {
                        if (V.NO_DELETE_TAGS.indexOf(s.tagName) < 0) {
                            if (b(e).replaceWith(V.MARKERS), (t = v.node.contents(n)).length && "BR" === t[t.length - 1].tagName && b(t[t.length - 1]).remove(), s.isContentEditable && "DIV" === s.tagName && (!v.node.isBlock(s.previousSibling) || "DIV" === s.previousSibling.tagName)) return;
                            b(n).append(b(s).html()), b(s).remove()
                        }
                    } else {
                        for ((t = v.node.contents(n)).length && "BR" === t[t.length - 1].tagName && b(t[t.length - 1]).remove(), b(e).replaceWith(V.MARKERS); s && !v.node.isBlock(s) && "BR" !== s.tagName;) b(n).append(b(s)), s = s.nextSibling;
                        b(s).remove()
                    }
                }
            }
        }
    }, V.NO_DELETE_TAGS = ["TH", "TD", "TR", "TABLE", "FORM"], V.SIMPLE_ENTER_TAGS = ["TH", "TD", "LI", "DL", "DT", "FORM"], V.MODULES.cursor = function(g) {
        var C = g.$;
            ...
            if (e) {
                ...
                if ("LI" !== e.parentNode.parentNode.tagName || !l || null != l.previousSibling) {
                    ...
                    if (e) {
                        ...
                        c.attr(n), c.insertBefore(e), (r = b(e)) && (0 <= ["strong", "em"].indexOf(t) || "span" === t && n.hasOwnProperty("style")) && (i = "span" === t ? (o = (a = n.style.replace(/;$/, "").split(":"))[0].trim(), a[1].trim()) : (o = a[t].prop, a[t].val), "background-color" !== o && (O(r).css(o, i), function C(e, t) {
                        ...
                        for (var d = e; d && !O(d).hasClass("fr-marker") && 0 === O(d).find(".fr-marker").length && "UL" !== d.tagName && "OL" !== d.tagName;) {
                            var f = d;
                            if ("SPAN" === d.tagName && O(d).hasClass("fr-tracking-deleted")) d = d.nextSibling;
                            else {
                                if (x.node.isBlock(d) && "HR" !== e.tagName) return v(d.firstChild, t, n), !1;
                                if ("SPAN" === d.tagName && x.node.isEditable(d)) return c.is(":empty") && c.remove(), v(d.firstChild, t, n), !1;
                                if (d.tagName && d.hasAttribute("contenteditable") && "false" === d.getAttribute("contenteditable")) {
                                    var p = c.get(0).parentNode,
                                        h = d.nextSibling;
                                    return "P" === d.parentNode.tagName && null == d.nextSibling ? h = d.parentNode.nextSibling : !h && p && p.nextSibling && "DIV" === p.nextSibling.tagName && (h = p.nextSibling), void v(h, t, n)
                                }
                                if (!x.node.isEditable(d.parentNode)) return x.selection.restore(), void x.toolbar.disable();
                                d = d.nextSibling, c.append(f), x.browser.mozilla && 0 < c.length && m(c[0])
                            }
                        }
                        if (d)(O(d).find(".fr-marker").length || "UL" === d.tagName || "OL" === d.tagName) && v(d.firstChild, t, n);
                        else {
                            for (var u = c.get(0).parentNode; u && !u.nextSibling && !x.node.isElement(u);) u = u.parentNode;
                            if (u) {
                                var g = u.nextSibling;
        ...
        function m(e) {
            if (O(e).parentsUntil(x.$el, "TABLE").length) {
                for (var t = null, n = e.nextSibling; n;) "BR" === n.nodeName && (t = n), n = n.nextSibling;
        ...
        function l(e, t) {
            ...
            if (void 0 === t && (t = {}), t.style && delete t.style, x.selection.isCollapsed()) {
                ...
                r.get(0).nextSibling && x.node.isBlock(r.get(0).nextSibling) && !r.get(0).previousSibling && "LI" === r.get(0).parentNode.tagName && r.get(0).nextSibling.prepend(r.get(0)), r.replaceWith(function l(e, t) {
                    var n = "<".concat(e);
        ...
        function $(e, t, n, r) {
            if (!r) {
                var o = !1;
                if (!0 === e.data("type"))
                    for (; x.node.isFirstSibling(e.get(0)) && !e.parent().is(x.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().before(e), o = !0;
                else if (!1 === e.data("type"))
                    for (; x.node.isLastSibling(e.get(0)) && !e.parent().is(x.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().after(e), o = !0;
                if (o) return !0
            }
            if (e.parents(t).length || void 0 === t) {
                ...
                return e.replaceWith('<span id="mark"></span>'), i = l.html().replace(/<span id="mark"><\/span>/, a + x.node.closeTagString(l.get(0)) + s + c + a + x.node.openTagString(l.get(0)) + s), l.replaceWith(x.node.openTagString(l.get(0)) + i + x.node.closeTagString(l.get(0))), !0
            }
            return !1
        }
        ...
        function c(e, t) {
            ...
            for (var s = !0; s;) {
                ...
                for (var l = x.$el.find(".fr-marker"), c = 0; c < l.length; c++) {
                    var d = O(l[c]),
                        f = null;
                    if (d.attr("data-cloned") || n || (f = d.clone().removeClass("fr-marker").addClass("fr-clone"), d.data("type") && "true" === d.data("type").toString() ? d.attr("data-cloned", !0).after(f) : d.attr("data-cloned", !0).before(f)), $(d, e, t, n)) {
                        s = !0;
                        break
                    }
                }
                ...
                for (var o, i = {
                    ...
                    var l = a[s];
                    if (l.innerHTML && 8203 == l.innerHTML.charCodeAt() && l.tagName.toLocaleLowerCase() == n && l.childNodes.length < 2 && !x.helpers.isMobile() && (l.outerHTML = l.innerHTML), x.node.hasClass(l, "fr-marker")) t = (t + 1) % 2;
                    else if (t)
                        if (0 < O(l).find(".fr-marker").length) t = M(O(l), t, n, r);
                        else {
                            (o = "LI" === l.tagName ? l : O(l).parentsUntil(x.$el, "li").get(0)) && (void 0 === n || 0 <= ["strong", "em"].indexOf(n)) && (n ? O(o).css(i[n].prop, "") : o.style = ""), (o = l.parentNode !== x.el ? l.parentNode : null) && 1 === o.nodeType && ["p", "strong", "u", "em", "s", "sub", "sup", "a"].indexOf(n) < 0 && o.hasAttribute("style") && "SPAN" !== o.tagName && "LI" !== o.tagName ? o.style = "" : l && 1 === l.nodeType && l.hasAttribute("style") && ["p", "strong", "u", "em", "s", "sub", "sup", "a"].indexOf(n) < 0 && (x.browser.msie ? O(l).attr("style", "") : l.style = "");
                ...
                return t
            }(x.$el, 0, e, t), n || (x.$el.find(".fr-marker").remove(), x.$el.find(".fr-clone").removeClass("fr-clone").addClass("fr-marker")), n && x.$el.find(".fr-marker").before(V.INVISIBLE_SPACE).after(V.INVISIBLE_SPACE), x.html.cleanEmptyTags(), x.el.normalize(), x.selection.restore();
            ...
            if (x.selection.isCollapsed()) {
                ...
                if (x.node.openTagString(d.get(0)) === '<span style="'.concat(e, ": ").concat(d.css(e), ';">')) {
                    if (x.node.isEmpty(d.get(0))) c = O(x.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS)), d.replaceWith(c);
                        ...
                        var f = {};
                        f["style*"] = "".concat(e, ":"), $(r, "span", f, !0), r = x.$el.find(".fr-marker"), t ? (c = O(x.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS)), r.replaceWith(c)) : r.replaceWith(V.INVISIBLE_SPACE + V.MARKERS)
                    }
                    x.html.cleanEmptyTags()
                } else x.node.isEmpty(d.get(0)) && d.is("span") ? (r.replaceWith(V.MARKERS), d.css(e, t)) : (r.get(0).nextSibling && x.node.isBlock(r.get(0).nextSibling) && !r.get(0).previousSibling && "LI" === r.get(0).parentNode.tagName && r.get(0).nextSibling.prepend(r.get(0)), c = O(t ? '<span style="'.concat(e, ": ").concat(t, ';">').concat(V.INVISIBLE_SPACE).concat(V.MARKERS, "</span>") : "<span>".concat(V.INVISIBLE_SPACE).concat(V.MARKERS, "</span>")), r.replaceWith(c));
                c && L(c, e, t)
            } else {
                if (x.selection.save(), null === t || "color" === e && 0 < x.$el.find(".fr-marker").parents("u, a").length) {
                    ...
                    for (n = 0; n < p.length; n++)
                        if (!0 === (r = O(p[n])).data("type") || "true" === r.data("type"))
                            ...
                            for (; x.node.isLastSibling(r.get(0)) && !r.parent().is(x.$el) && !x.node.isElement(r.parent().get(0)) && !x.node.isBlock(r.parent().get(0));) r.parent().after(r)
                }
                for (var h = x.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling; h.firstChild;) h = h.firstChild;
                var u = {
                    "class": "fr-unprocessed"
                };
                for (t && (u.style = "".concat(e, ": ").concat(t, ";")), v(h, "span", u), x.$el.find(".fr-marker + .fr-unprocessed").each(function() {
                    ...
                    for (i = c.find("span"), o && "background-color" !== e && (o.normalize(), i = O(o).find("span:not(.fr-unprocessed)")), n = i.length - 1; 0 <= n; n--) a = i[n], s = e, l = void 0, (l = O(a)).css(s, ""), "" === l.attr("style") && l.replaceWith(l.html());
                    L(c, e, t)
                }
            }! function m() {
                var e;
                ...
                x.$el.find("span[style] span[style]").each(function() {
                    if (0 <= O(this).attr("style").indexOf("font-size")) {
                        ...
                        e.attr("style") && 0 <= e.attr("style").indexOf("background-color") && (O(this).attr("style", function o(e, t) {
                            var n = function n(e) {
                                    return e.split(";").reduce(function(e, t) {
                                        var n = t.split(":"),
                                            ...
                                            o = r[0],
                                            i = r[1];
                                        return o && i && (e[o.trim()] = i.trim()), e
                                    }, {})
                                },
                                r = Object.assign(n(t), n(e));
                        ...
                        }(O(this).attr("style"), e.attr("style"))), $(O(this), "span[style]", {}, !1))
                    }
        ...
        function b(e) {
            ...
            if (t = "LI" === e.tagName ? e : O(e).parentsUntil(x.$el, "li").get(0)) {
                ...
                if (a.atStart && !a.atEnd && (n = O(t).find(".fr-marker[data-type=false]").get(0), r = O(n).parentsUntil(x.$el, "li").get(0), o = O(n).parent().get(0), (i = n.nextSibling) && 0 <= ["UL", "OL"].indexOf(i.tagName) || !r.isSameNode(t) || !i && ("LI" === o.tagName || !o.nextSibling || 0 <= ["UL", "OL"].indexOf(o.nextSibling.tagName) || x.node.isVoid(o.nextSibling)))) return t
            }
        }

        function L(e, t, n) {
            var r, o, i, a = e.parentsUntil(x.$el, "span[style]"),
                s = [];
            for (r = a.length - 1; 0 <= r; r--) o = a[r], i = t, 0 === O(o).attr("style").indexOf("".concat(i, ":")) || 0 <= O(o).attr("style").indexOf(";".concat(i, ":")) || 0 <= O(o).attr("style").indexOf("; ".concat(i, ":")) || s.push(a[r]);
            if ((a = a.not(s)).length) {
                for (var l = "", c = "", d = "", f = "", p = e.get(0); p = p.parentNode, O(p).addClass("fr-split"), l += x.node.closeTagString(p), c = x.node.openTagString(O(p).clone().addClass("fr-split").get(0)) + c, a.get(0) !== p && (d += x.node.closeTagString(p), f = x.node.openTagString(O(p).clone().addClass("fr-split").get(0)) + f), a.get(0) !== p;);
            ...
            toggle: function f(e, t) {
                if (x.browser.safari && x.shared.safariSelection) {
                    var n = x.shared.safariSelection,
                        ...
                        a = n.endOffset,
                        s = x.doc.createRange();
                    s.setStart(r, i), s.setEnd(o, a), x.selection.get().removeAllRanges(), x.selection.get().addRange(s), x.shared.safariSelection = null
                }
                d(e, t) ? c(e, t) : l(e, t)
            },
            apply: l,
        ...
        return {
            ...
            set: function N(e) {
                ...
                w.edit.on(), w.core.injectStyle(w.opts.iframeDefaultStyle + w.opts.iframeStyle), g(), w.opts.useClasses || (w.$el.find("[fr-original-class]").each(function() {
                ...
                })), p && w.edit.off(), w.events.trigger("html.set"), w.events.trigger("charCounter.update"), w.events.trigger("wordCounter.update")
            },
            syncInputs: _,
            get: function B(e, t) {
                                ...
                                if (c[f].selectorText && 0 < c[f].style.cssText.length) {
                                    ...
                                    for (o = 0; o < u.length; o++) {
                                        ...
                                        for (var g = 1e3 * d + $(c[f].selectorText), C = c[f].style.cssText.split(";"), m = 0; m < C.length; m++) {
                                            ...
                                            if (v && !v.match(l) && ((!a[u[o]][v] || a[u[o]][v] && "" == u[o].getAttribute("fr-original-style")) && (a[u[o]][v] = 0) <= (u[o].getAttribute("fr-original-style") || "").indexOf("".concat(v, ":")) && (a[u[o]][v] = 1e4), g >= a[u[o]][v] && (a[u[o]][v] = g, C[m].trim().length))) {
                                                var b = C[m].trim().split(":");
                                                b.splice(0, 1);
                                                var L = b.join(":").trim(); - 1 < L.indexOf("!important") && (g += 1), s.push([u[o], v.trim(), L, g])
                                            }
                                        }
                                    }
                                }
                ...
                if (w.node.isEmpty(w.el)) w.opts.fullPage && (n = k(w.iframe_document), n += "<html".concat(w.node.attributes(w.$html.get(0)), ">").concat(w.$html.find("head").get(0).outerHTML, "<body></body></html>"));
                    ...
                    var T = w.opts.heightMin,
                        M = w.opts.height,
                        A = w.opts.heightMax;
                    w.opts.heightMin = null, w.opts.height = null, w.opts.heightMax = null, w.size.refresh(), n += "<html".concat(w.node.attributes(w.$html.get(0)), ">").concat(w.$html.html(), "</html>"), w.opts.iframe && w.$html && 0 < w.$html.find(".fr-element").length && (n = w.$html.find(".fr-element").html()), w.opts.heightMin = T, w.opts.height = M, w.opts.heightMax = A, w.size.refresh(), w.$el.addClass("fr-view")
                } else n = w.$el.html(), w.opts.iframe && w.$html && 0 < w.$html.find(".fr-element").length && (n = w.$html.find(".fr-element").html());
            ...
            getSelected: function T() {
                function e(e, t) {
                    for (; t && (t.nodeType === Node.TEXT_NODE || !w.node.isBlock(t)) && !w.node.isElement(t) && !w.node.hasClass(t, "fr-inner") && (w.opts.enter !== V.ENTER_BR || t !== w.$el[0]);) t && t.nodeType !== Node.TEXT_NODE && u(e).wrapContent(t), t = t.parentNode;
            ...
            insert: function M(e, t, n) {
                var r;
                if (w.selection.isCollapsed() || w.selection.remove(), r = t ? e : w.clean.html(e), 0 === e.indexOf('<i class="fa ') && (r = "<span>&nbsp;".concat(r, "</span>")), e.indexOf('class="fr-marker"') < 0 && (r = function s(e) {
                        var t = w.doc.createElement("div");
                    ...
                    if (o)
                        if (w.opts.trackChangesEnabled) w.track_changes.pasteInEdior(r);
                            ...
                            if ((f(r) || n) && (w.node.deepestParent(o) || i && "LI" === i.tagName)) {
                                ...
                                var a = w.selection.element();
                                if (a && u(a).parentsUntil(w.el, "ul, ol").length && "LI" != o.parentNode.tagName && ("DIV" == u(r).get(0).tagName && 1 == u(r).length && "UL" == u(r).get(0).firstChild.tagName ? r = u(r).get(0).firstChild.innerHTML : "UL" == u(r).get(0).tagName && (r = u(r).get(0).innerHTML), o = w.markers.split()), !(o = w.markers.split())) return !1;
                                o.outerHTML = r
                            } else o.outerHTML = r
                        }
        ...
        function v(e) {
            if (g.selection.isCollapsed())
                if (["INPUT", "BUTTON", "TEXTAREA"].indexOf(e.target && e.target.tagName) < 0 && g.cursor.backspace(), g.helpers.isIOS()) {
                    var t = g.selection.ranges(0);
                    t.deleteContents(), t.insertNode(document.createTextNode("\u200b")), g.selection.get().modify("move", "forward", "character")
                } else ["INPUT", "BUTTON", "TEXTAREA"].indexOf(e.target && e.target.tagName) < 0 && e.preventDefault(), e.stopPropagation();
            else e.preventDefault(), e.stopPropagation(), g.selection.remove();
            g.placeholder.refresh()
        }

        function b(e) {
            ["INPUT", "BUTTON", "TEXTAREA"].indexOf(e.target && e.target.tagName) < 0 && e.preventDefault(), e.stopPropagation(), "" !== g.selection.text() || g.selection.element().hasAttribute("contenteditable") && "false" === g.selection.element().getAttribute("contenteditable") || !g.selection.isCollapsed() && "IMG" == g.selection.element().tagName ? g.selection.remove() : g.cursor.del(), g.placeholder.refresh()
        }
        ...
        function e() {
            if (g.browser.mozilla && g.selection.isCollapsed() && !m) {
                var e = g.selection.ranges(0),
                    t = e.startContainer,
                    n = e.startOffset;
                t && t.nodeType === Node.TEXT_NODE && n <= t.textContent.length && 0 < n && 32 === t.textContent.charCodeAt(n - 1) && (g.selection.save(), g.spaces.normalize(), g.selection.restore())
            }
        }
        ...
        function t() {
            g.selection.isFull() && setTimeout(function() {
                ...
                e ? g.$el.html("<".concat(e, ">").concat(V.MARKERS, "<br/></").concat(e, ">")) : g.$el.html("".concat(V.MARKERS, "<br/>")), g.selection.restore(), g.placeholder.refresh(), g.button.bulkRefresh(), g.undo.saveStep()
            }, 0)
        }
        ...
        function L() {
            var e = g.html.defaultTag();
            e ? g.$el.html("<".concat(e, ">").concat(V.MARKERS, "<br/></").concat(e, ">")) : g.$el.html("".concat(V.MARKERS, "<br/>")), g.selection.restore()
        }
        ...
        function E(e, t) {
            ...
            if (e.parentElement && (-1 < e.innerHTML.indexOf("<span") || -1 < e.parentElement.innerHTML.indexOf("<span") || n && -1 < e.parentElement.parentElement.innerHTML.indexOf("<span")) && (e.classList.contains("fr-img-space-wrap") || e.parentElement.classList.contains("fr-img-space-wrap") || n && e.parentElement.parentElement.classList.contains("fr-img-space-wrap"))) {
                if (a(e.parentElement).is("p")) {
                    ...
                    return (r = r.replace(/<br>/g, "")).length < 1 ? e.parentElement.insertAdjacentHTML("afterbegin", "&nbsp;") : "&nbsp;" != r && " " != r && "Backspace" == t.key ? v(t) : "&nbsp;" != r && " " != r && "Delete" == t.key && b(t), !0
                }
                if (a(e).is("p")) {
                    var o = e.innerHTML.replace(/<br>/g, "");
                    return o.length < 1 ? e.insertAdjacentHTML("afterbegin", "&nbsp;") : "&nbsp;" != o && " " != o && "Backspace" == t.key ? v(t) : "&nbsp;" != o && " " != o && "Delete" == t.key && b(t), !0
                }
            }
            return !1
        }
        ...
        function s(e) {
            ...
            if (e && N(e.which)) {
                ...
                if (o.nodeType === Node.TEXT_NODE && 0 < i && 1 < o.textContent.length && 8203 === o.textContent.charCodeAt(i)) {
                    ...
                    g.selection.get().removeAllRanges(), a.setStart(o, i - 1), a.setEnd(o, i - 1), g.selection.get().addRange(a)
                }
                return !0
            }
            ...
            var s = e.which;
            if (16 === s) return !0;
            if ((C = s) === V.KEYCODE.IME) return m = !0;
            if (m = !1, S(e)) return !0;
            var l = T(s) && !S(e) && !e.altKey,
                c = s === V.KEYCODE.BACKSPACE || s === V.KEYCODE.DELETE;
            if ((g.selection.isFull() && !g.opts.keepFormatOnDelete && !g.placeholder.isVisible() || c && g.placeholder.isVisible() && g.opts.keepFormatOnDelete) && (l || c) && (L(), !T(s))) return e.preventDefault(), !0;
            if (s === V.KEYCODE.ENTER) !g.helpers.isIOS() && e.shiftKey || t.classList.contains("fr-inner") || t.parentElement.classList.contains("fr-inner") ? function d(e) {
                e.preventDefault(), e.stopPropagation(), g.opts.multiLine && (g.selection.isCollapsed() || g.selection.remove(), g.cursor.enter(!0))
            }(e) : function f(e) {
                g.opts.multiLine ? (g.helpers.isIOS() || (e.preventDefault(), e.stopPropagation()), g.selection.isCollapsed() || g.selection.remove(), g.cursor.enter()) : (e.preventDefault(), e.stopPropagation())
            }(e);
            else if (s === V.KEYCODE.BACKSPACE && (e.metaKey || e.ctrlKey)) ! function p() {
                setTimeout(function() {
                    g.events.disableBlur(), g.events.focus()
                }, 0)
            }();
            else if (s !== V.KEYCODE.BACKSPACE || S(e) || e.altKey)
                if (s !== V.KEYCODE.DELETE || S(e) || e.altKey || e.shiftKey) s === V.KEYCODE.SPACE ? function h(e) {
                    var t = g.selection.element();
                    if (!g.helpers.isMobile() && t && "A" === t.tagName) {
                        e.preventDefault(), e.stopPropagation(), g.selection.isCollapsed() || g.selection.remove();
                        var n = g.markers.insert();
                        if (n) {
                            var r = n.previousSibling;
                            !n.nextSibling && n.parentNode && "A" === n.parentNode.tagName ? (n.parentNode.insertAdjacentHTML("afterend", "&nbsp;".concat(V.MARKERS)), n.parentNode.removeChild(n)) : (r && r.nodeType === Node.TEXT_NODE && 1 === r.textContent.length && 160 === r.textContent.charCodeAt(0) ? r.textContent += " " : n.insertAdjacentHTML("beforebegin", "&nbsp;"), n.outerHTML = V.MARKERS), g.selection.restore()
                        }
                    }
                }(e) : s === V.KEYCODE.TAB ? function u(e) {
                    if (0 < g.opts.tabSpaces)
                        if (g.selection.isCollapsed()) {
                            g.undo.saveStep(), e.preventDefault(), e.stopPropagation();
                            for (var t = "", n = 0; n < g.opts.tabSpaces; n++) t += "&nbsp;";
                            g.html.insert(t), g.placeholder.refresh(), g.undo.saveStep()
                        } else e.preventDefault(), e.stopPropagation(), e.shiftKey ? g.commands.outdent() : g.commands.indent()
                }(e) : S(e) || !T(e.which) || g.selection.isCollapsed() || e.ctrlKey || e.altKey || g.browser.mozilla || g.selection.remove();
                else {
                    if (E(t, e)) return e.preventDefault(), void e.stopPropagation();
                    g.placeholder.isVisible() ? (g.opts.keepFormatOnDelete || L(), e.preventDefault(), e.stopPropagation()) : b(e)
                }
            else {
                if (E(t, e)) return e.preventDefault(), void e.stopPropagation();
                g.placeholder.isVisible() ? (g.opts.keepFormatOnDelete || L(), e.preventDefault(), e.stopPropagation()) : v(e)
            }
            g.events.enableBlur()
        }
        ...
        function l() {
            ...
            if (g.opts.height || g.opts.heightMax) {
                e = g.position.getBoundingRect().top, (g.helpers.isIOS() || g.helpers.isAndroid()) && (e -= g.helpers.scrollTop()), g.opts.iframe && (e += g.$iframe.offset().top);
                var t = g.selection.blocks(),
                    n = null;
                if (t && 0 < t.length && t[0].offsetTop && (n = t[0].getBoundingClientRect().top, 3 === g.selection.get().anchorNode.nodeType)) {
                    var r = g.doc.createRange(),
                        o = g.selection.get().anchorNode,
                        i = g.selection.get().anchorOffset;
                    r.selectNode(o), r.setStart(o, i), n = r.getBoundingClientRect().top
        ...
        function c(e) {
            ...
            if (function a(e) {
                ...
                var r = g.$el.find(".fr-marker")[1],
                    o = (e || "").which;
                g.opts.enter === V.ENTER_BR && n === g.$el.get(0) && 8 === o && null == r.nextSibling || y(n), g.selection.restore()
            }
        }
        ...
        function d(e) {
            var t = e.which;
            if (S(e) || 37 <= t && t <= 40 || !T(t) && t !== V.KEYCODE.DELETE && t !== V.KEYCODE.BACKSPACE && t !== V.KEYCODE.ENTER && t !== V.KEYCODE.IME) return !0;
            n || (r = g.snapshot.get(), g.undo.canDo() || g.undo.saveStep()), clearTimeout(n), n = setTimeout(function() {
                n = null, g.undo.saveStep()
            }, Math.max(250, g.opts.typingTimer))
        }

        function f(e) {
            var t = e.which;
            if (S(e) || 37 <= t && t <= 40) return !0;
            r && n ? (g.undo.saveStep(r), r = null) : void 0 !== t && 0 !== t || r || n || g.undo.saveStep()
        }
        ...
        function h(e) {
            ...
            return r && "TR" == r.tagName && r.getAttribute("contenteditable") == undefined && (r = r.closest("table")), !g.node.isEditable(e.target) || r && "false" === r.getAttribute("contenteditable") ? g.toolbar.disable() : g.toolbar.enable(), !(!e.target || e.target === g.el) || (0 === t.length || void(t[0].offsetHeight + t[0].offsetTop <= e.offsetY ? p(t[t.length - 1]) && (n ? g.$el.append("<".concat(n, ">").concat(V.MARKERS, "<br></").concat(n, ">")) : g.$el.append("".concat(V.MARKERS, "<br>")), g.selection.restore(), l()) : e.offsetY <= 10 && p(t[0]) && (n ? g.$el.prepend("<".concat(n, ">").concat(V.MARKERS, "<br></").concat(n, ">")) : g.$el.prepend("".concat(V.MARKERS, "<br>")), g.selection.restore(), l())))
        }
        ...
        return {
            _init: function M() {
                g.events.on("keydown", d), g.events.on("input", e), g.events.on("mousedown", i), g.events.on("keyup input", f), g.events.on("keypress", o), g.events.on("keydown", s), g.events.on("keyup", c), g.events.on("destroy", u), g.events.on("html.inserted", c), g.events.on("cut", t), g.opts.multiLine && g.events.on("click", h), g.events.on("initialized", function() {
                    g.el.addEventListener("compositionstart", function() {
                        if (g.selection.isCollapsed()) {
                            ...
                            if (t && t.nodeType === Node.TEXT_NODE && n <= t.textContent.length && 0 < n && 8203 === t.textContent.charCodeAt(n - 1)) {
                                ...
                                a(r.get(0).previousSibling).before(V.HAIR_SPACE), r.get(0).previousSibling.textContent = r.get(0).previousSibling.textContent.replace(/\u200B/gi, ""), g.selection.restore()
                            }
                        }
                        ...
                        if (g.selection.isCollapsed()) {
                            ...
                            if (t && t.nodeType === Node.TEXT_NODE && n <= t.textContent.length && 0 < n && 8202 === t.textContent.charCodeAt(0)) {
                                g.selection.save();
                                var r = g.$el.find(".fr-marker");
                                r.get(0).previousSibling.textContent = r.get(0).previousSibling.textContent.replace(/\u200A/gi, ""), g.selection.restore()
                            }
                        }
                    })
                })
            ...
            forceUndo: function A() {
                n && (clearTimeout(n), g.undo.saveStep(), r = null)
            },
            isIME: function x() {
                return m
            },
        ...
        function t(e) {
            if ("INPUT" === (c = e).target.nodeName && "text" === e.target.type) return !0;
            if (A.edit.isDisabled()) return !1;
            if (d(e.target)) return !1;
            if (r) return !1;
            ...
            return function a() {
                if (A.selection.save(), A.events.disableBlur(), s = null, l) {
                    ...
                    } else l = k('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 2147483647; line-height: 140%; -moz-user-select: text; -webkit-user-select: text; -ms-user-select: text; user-select: text;" tabIndex="-1"></div>');
                    A.browser.webkit || A.browser.mozilla ? ("none" === n && l.css("top", A.$sc.scrollTop()), A.$el.after(l)) : A.browser.edge && A.opts.iframe ? A.$el.append(l) : A.$box.after(l), A.events.on("destroy", function() {
                        l.remove()
                    })
                }
                var o;
                ...
                4e5 < i.length ? (c.preventDefault(), i = p(i), l.get(0).innerHTML = i, setTimeout(function() {
                    A.win.setTimeout(h, 1)
                }, 0)) : (l.focus(), A.win.setTimeout(h, 1))
            }(), !1
        }
        ...
        function o(e) {
            if (e.originalEvent && (e = e.originalEvent), d(e.target)) return !1;
            if (e && e.dataTransfer && e.dataTransfer.getData) {
                var t = "";
                if (O = e.dataTransfer.types, A.helpers.isArray(O))
                    for (var n = 0; n < O.length; n++) t += "".concat(O[n], ";");
                else t = O;
                if (s = "", /text\/rtf/.test(t) && (i = e.dataTransfer.getData("text/rtf")), /text\/html/.test(t) ? s = e.dataTransfer.getData("text/html") : /text\/rtf/.test(t) && A.browser.safari ? s = i : /text\/plain/.test(t) && !this.browser.mozilla && (s = A.html.escapeEntities(e.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")), "" !== s) {
                    ...
                    if (A.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-placeholder"), A.$el.find(".fr-marker-helper").addClass("fr-marker").removeClass("fr-marker-helper"), A.selection.restore(), A.selection.remove(), A.$el.find(".fr-marker-placeholder").addClass("fr-marker").removeClass("fr-marker-placeholder"), !1 !== r) {
                        var o = A.el.querySelector(".fr-marker");
                        return k(o).replaceWith(V.MARKERS), A.selection.restore(), h(), e.preventDefault && (e.stopPropagation(), e.preventDefault()), !1
                    }
                } else s = null
            }
        }
        ...
        function p(e) {
            var t = A.html.defaultTag() || "p",
                n = "</".concat(t, "><").concat(t, ">");
            return A.opts.enter === V.ENTER_BR ? n = "<br />" : e = "<".concat(t, ">") + e, e.replace(/\n{2,}/g, n)
        }

        function h() {
            A.opts.iframe && A.$el.attr("contenteditable", "true"), A.browser.edge && A.opts.iframe && A.$box.after(l), w || (A.keys.forceUndo(), w = A.snapshot.get()), s || (s = l.get(0).innerHTML, x = l.text(), A.$el[0].setAttribute("plainpaste", !0), A.selection.restore(), A.events.enableBlur());
            var e = s.match(/(MSFontService|class="?Mso|class='?Mso|class="?Xl|class='?Xl|class=Xl|style="[^"]*\bmso-|style='[^']*\bmso-|w:WordDocument|LibreOffice)/gi),
        ...
        function a(e, t, n) {
            ...
            var s = !1;
            0 <= e.indexOf('id="docs-internal-guid') && (e = e.replace(/^[\w\W\s\S]* id="docs-internal-guid[^>]*>([\w\W\s\S]*)<\/b>[\w\W\s\S]*$/g, "$1"), s = !0), (0 <= e.indexOf('content="Sheets"') || 0 <= e.indexOf("google-sheets-html-origin")) && (e = e.replace(/width:0px;/g, ""));
            var l = !1;
            if (!t)
                if ((l = function y() {
                        var e = null;
                    ...
                    A.opts.htmlAllowedStyleProps = A.opts.pasteAllowedStyleProps, A.opts.htmlAllowComments = !1, e = (e = (e = e.replace(/<span class="Apple-tab-span">\s*<\/span>/g, $(A.opts.tabSpaces || 4))).replace(/<span class="Apple-tab-span" style="white-space:pre">(\t*)<\/span>/g, function(e, t) {
                        return $(t.length * (A.opts.tabSpaces || 4))
                    })).replace(/\t/g, $(A.opts.tabSpaces || 4)), e = A.clean.html(e, A.opts.pasteDeniedTags, A.opts.pasteDeniedAttrs), A.opts.htmlAllowedStyleProps = c, A.opts.htmlAllowComments = !0, A.html.defaultTag() && "div" === A.html.defaultTag() || (e = H(e)), e = (e = e.replace(/\r/g, "")).replace(/^ */g, "").replace(/ *$/g, "")
                }!t || A.wordPaste && n || (0 === (e = e.replace(/^\n*/g, "").replace(/^ /g, "")).indexOf("<colgroup>") && (e = "<table>".concat(e, "</table>")), e = H(e = function S(e) {
                var t;
                ...
                return function a(e) {
                    for (var t = A.node.contents(e), n = 0; n < t.length; n++) t[n].nodeType !== Node.TEXT_NODE && t[n].nodeType !== Node.ELEMENT_NODE ? t[n].parentNode.removeChild(t[n]) : a(t[n])
                }(r), r.innerHTML
            }(e));
            ...
            if (A.$el[0].removeAttribute("plainpaste", !0), "string" == typeof d && (e = d), "" !== e) {
                ...
                if (f.childNodes[0] instanceof HTMLHeadingElement && A.selection.element().tagName === f.childNodes[0].tagName && (f.childNodes[0].outerHTML = f.childNodes[0].innerHTML), f.children && 0 < f.children.length)
            ...
            }(), A.undo.saveStep(w), w = null, A.undo.saveStep()
        }
        ...
        return {
            _init: function C() {
                ...
                }, !0), A.events.on("beforepaste", t)), A.events.on("destroy", g)
            },
        ...
        function e() {
            ...
            r.opts.fullPage && e && (r.opts.heightMin && r.$iframe.css("minHeight", r.opts.heightMin), r.opts.heightMax && r.$iframe.css("maxHeight", r.opts.heightMax), r.$el.css("overflow-y", "auto")), r.opts.iframe && r.markdown && r.markdown.isEnabled() ? r.$iframe.height(r.$wp.parent().outerHeight(!0)) : r.$iframe.height(r.$el.outerHeight(!0))
        }
        ...
        function n() {
            if (l.$box.addClass("fr-box".concat(l.opts.editorClass ? " ".concat(l.opts.editorClass) : "")), l.$box.attr("role", "application"), l.$wp.addClass("fr-wrapper"), l.opts.documentReady && l.$box.addClass("fr-document"), function a() {
                    l.opts.iframe || l.$el.addClass("fr-element fr-view"), (l.opts.height && l.opts.height < window.innerHeight || l.opts.heightMax && l.opts.heightMax < window.innerHeight) && l.$el.addClass("fr-element-scroll-visible")
                }(), l.opts.iframe) {
                l.$iframe.addClass("fr-iframe"), l.$el.addClass("fr-view");
                for (var e = 0; e < l.o_doc.styleSheets.length; e++) {
                    ...
                    if (l.o_doc.styleSheets[e].href && (-1 < l.o_doc.styleSheets[e].href.indexOf("codemirror") || -1 < l.o_doc.styleSheets[e].href.indexOf("font-awesome")) && (n = !(t = null)), t)
                        for (var r = 0, o = t.length; r < o; r++)
                            if (!t[r].selectorText || 0 !== t[r].selectorText.indexOf(".fr-view") && 0 !== t[r].selectorText.indexOf(".fr-element") && 0 !== t[r].selectorText.indexOf(".fr-box.fr-basic .fr-element") && 0 !== t[r].selectorText.indexOf(".fr-markdown-view") && 0 !== t[r].selectorText.indexOf(".fr-markdown-editor") && 0 !== t[r].selectorText.indexOf(".fr-wrapper-markdown") && 0 !== t[r].selectorText.indexOf(".gutter-horizontal") && 0 !== t[r].selectorText.indexOf(".e-resize-handler")) try {
                                n && l.o_doc.styleSheets[e].href && t[r].selectorText && (l.opts.iframeStyle += "".concat(t[r].selectorText, "{").concat(t[r].style.cssText, "}"), n = !1)
                            } catch (s) {} else 0 < t[r].style.cssText.length && (0 === t[r].selectorText.indexOf(".fr-box.fr-basic .fr-element") && (l.opts.iframeStyle += "".concat(t[r].selectorText, "{").concat(t[r].style.cssText, "}")), 0 === t[r].selectorText.indexOf(".fr-view") ? l.opts.iframeStyle += "".concat(t[r].selectorText.replace(/\.fr-view/g, "body"), "{").concat(t[r].style.cssText, "}") : l.opts.iframeStyle += "".concat(t[r].selectorText.replace(/\.fr-element/g, "body"), "{").concat(t[r].style.cssText, "}"));
            ...
            "auto" !== l.opts.direction && l.$box.removeClass("fr-ltr fr-rtl").addClass("fr-".concat(l.opts.direction)), l.$el.attr("dir", l.opts.direction), l.$wp.attr("dir", l.opts.direction), 1 < l.opts.zIndex && l.$box.css("z-index", l.opts.zIndex), l.opts.theme && l.$box.addClass("".concat(l.opts.theme, "-theme")), l.opts.tabIndex = l.opts.tabIndex || l.$oel.attr("tabIndex"), l.opts.tabIndex && l.$el.attr("tabIndex", l.opts.tabIndex)
        }
        return {
            _init: function r() {
                if (V.INSTANCES.push(l), function e() {
                        l.drag_support = {
                    ...
                    n(), l.html.set(l._original_html), l.$el.attr("spellcheck", l.opts.spellcheck), l.helpers.isMobile() && (l.$el.attr("autocomplete", l.opts.spellcheck ? "on" : "off"), l.$el.attr("autocorrect", l.opts.spellcheck ? "on" : "off"), l.$el.attr("autocapitalize", l.opts.spellcheck ? "on" : "off")), l.opts.disableRightClick && l.events.$on(l.$el, "contextmenu", function(e) {
                ...
                }), l.$oel.val(l.html.get())), l.helpers.isIOS() && l.events.$on(l.$doc, "selectionchange", function() {
                    l.$doc.get(0).hasFocus() || l.$win.get(0).focus()
                }), l.events.trigger("init"), l.opts.autofocus && !l.opts.initOnClick && l.$wp && l.events.on("initialized", function() {
                    l.events.focus(!0)
                })
            },
            destroy: function t(e) {
                "TEXTAREA" === l.$oel.get(0).tagName && l.$oel.val(e), l.$box && l.$box.removeAttr("role"), l.$wp && ("TEXTAREA" === l.$oel.get(0).tagName ? (l.$el.html(""), l.$wp.html(""), l.$box.replaceWith(l.$oel), l.$oel.show()) : (l.$wp.replaceWith(e), l.$el.html(""), l.$box.removeClass("fr-view fr-ltr fr-box ".concat(l.opts.editorClass || "")), l.opts.theme && l.$box.addClass("".concat(l.opts.theme, "-theme")))), this.$wp = null, this.$el = null, this.el = null, this.$box = null
            },
            isEmpty: function e() {
            ...
            getXHR: function o(e, t) {
                ...
                for (var r in n.open(t, e, !0), l.opts.requestWithCredentials && (n.withCredentials = !0), l.opts.requestHeaders) Object.prototype.hasOwnProperty.call(l.opts.requestHeaders, r) && n.setRequestHeader(r, l.opts.requestHeaders[r]);
                return n
            },
            injectStyle: function i(e) {
                if (l.opts.iframe) {
                    l.$head.find("style[data-fr-style], link[data-fr-style]").remove(), l.$head.append('<style data-fr-style="true">'.concat(e, "</style>"));
                    for (var t = 0; t < l.opts.iframeStyleFiles.length; t++) {
                        ...
                        n.get(0).addEventListener("load", l.size.syncIframe), l.$head.append(n)
                    }
                }
            },
            hasFocus: function a() {
        ...
        function v(e) {
            for (var t in g)
                if (Object.prototype.hasOwnProperty.call(g, t) && m(t) && (void 0 === e || g[t].data("instance") === e)) return g[t];
            return !1
        }
        ...
        function E(a) {
            ...
            return {
                ...
                _preventFocus: function(e) {
                    ...
                    "mouseup" === e.type || d(n).is(":focus") || t.events.disableBlur(), "mouseup" !== e.type || d(n).hasClass("fr-command") || 0 < d(n).parents(".fr-command").length || d(n).hasClass("fr-dropdown-content") || d(n).hasClass("fr-dropdown-menu") || h.button.hideActiveDropdowns(s), (h.browser.safari || h.browser.mozilla) && "mousedown" === e.type && d(n).is("input[type=file]") && t.events.disableBlur();
                ...
                _windowKeydown: function(e) {
                    ...
                    var t = s.data("instance") || h,
                        n = e.which;
                    if (V.KEYCODE.ESC === n) {
                        if (t.popups.isVisible(a) && t.opts.toolbarInline) return e.stopPropagation(), t.popups.isVisible(a) && (s.findVisible(".fr-back").length ? (t.button.exec(s.findVisible(".fr-back").first()), t.accessibility.focusPopupButton(s)) : s.findVisible(".fr-dismiss").length ? t.button.exec(s.findVisible(".fr-dismiss").first()) : (t.popups.hide(a), t.toolbar.showInline(null, !0), t.accessibility.focusPopupButton(s))), !1;
                        if (t.popups.isVisible(a)) return s.findVisible(".fr-back").length ? (t.button.exec(s.findVisible(".fr-back").first), t.accessibility.focusPopupButton(s)) : s.findVisible(".fr-dismiss").length ? t.button.exec(s.findVisible(".fr-dismiss").first()) : (t.popups.hide(a), t.accessibility.focusPopupButton(s)), !1
                    }
                },
        ...
        function f(e, t) {
            ...
            }), h.$wp && !h.helpers.isMobile() && h.events.$on(h.$wp, "scroll.popup".concat(t), e._repositionPopup), h.events.on("window.mouseup", e._windowMouseup, !0), h.events.on("window.keydown", e._windowKeydown, !0), h.opts.iframe && window.addEventListener("click", e.handleWindowClick), g[t].data("inst".concat(h.id), !0), h.events.on("destroy", function() {
        ...
        return h.shared.exit_flag = !1, {
            ...
            create: function S(e, t) {
                ...
                }, !0), h.events.$on(d(h.o_win), "resize", r._windowResize, !0), "filesManager.insert" === e && g["filesManager.insert"].css("zIndex", 2147483641), n
            },
            get: function N(e) {
                var t = g[e];
            ...
            show: function T(e, t, n, r, o) {
                ...
                i.removeClass("fr-active").attr("aria-expanded", !1).parents(".fr-toolbar").css("zIndex", "").find("> .fr-dropdown-wrapper").css("height", ""), i.next().attr("aria-hidden", !0).css("overflow", "").find("> .fr-dropdown-wrapper").css("height", ""), g[e].data("instance", h), h.$tb && h.$tb.data("instance", h);
                var a = m(e);
                ...
                if (function p(e, t) {
                    ...
                    }(e, s), h.opts.toolbarInline && s && h.$tb && s.get(0) === h.$tb.get(0) && (C(e, h.$sc), n = h.$tb.offset().top - h.helpers.getPX(h.$tb.css("margin-top")), t = h.$tb.offset().left + h.$tb.outerWidth() / 2, h.node.hasClass(h.$tb.get(0), "fr-above") && n && (n += h.$tb.outerHeight()), r = 0), s = g[e].data("container"), h.opts.iframe && !r && !a) {
                ...
                s.is(h.$tb) ? h.$tb.css("zIndex", (h.opts.zIndex || 1) + 4) : g[e].css("zIndex", (h.opts.zIndex || 1) + 3), h.opts.toolbarBottom && s && h.$tb && s.get(0) === h.$tb.get(0) && (g[e].addClass("fr-above"), n && (n -= g[e].outerHeight())), o && (t -= g[e].width() / 2), t + g[e].outerWidth() > h.$sc.offset().left + h.$sc.width() && (t -= t + g[e].outerWidth() - h.$sc.offset().left - h.$sc.width()), t < h.$sc.offset().left && "rtl" === h.opts.direction && (t = h.$sc.offset().left), g[e].removeClass("fr-active"), h.position.at(t, n, g[e], r || 0);
        ...
        function c(t) {
            ...
            if (t && t.length && !n) {
                ...
                !f.browser.safari || l && null != f.shared.safariSelection || (f.shared.safariSelection = f.selection.get().getRangeAt(0).cloneRange()), o.events.disableBlur(), t.get(0).focus(), f.shared.$f_el = t
            }
        }
        ...
        function u(e, t) {
            var n = e.find("input, textarea, button, select, span").filter(function() {
                ...
                r = n.first();
            if ((n = r.parents(".fr-color-set").get(0) && r.parents(".fr-popup").get(0) ? n.filter("input") : t ? n.last() : n.first()).length) return a(n);
            if (f.shared.with_kb) {
        ...
        function b(e) {
            if (f.shared.$f_el) {
                var t;
                if (f.shared.$f_el.is(".fr-dropdown.fr-active")) return c(t = e ? f.shared.$f_el.next().find(".fr-command:not(.fr-disabled)").first() : f.shared.$f_el.next().find(".fr-command:not(.fr-disabled)").last()), !1;
                ...
                if (f.shared.$f_el.hasClass("fr-dropdown")) f.button.click(f.shared.$f_el);
                    ...
                    if (f.events.disableBlur(), f.button.click(f.shared.$f_el), f.shared.$f_el.attr("data-group-name")) {
                        var t = f.$tb.find('.fr-more-toolbar[data-name="'.concat(f.shared.$f_el.attr("data-group-name"), '"]')),
                            n = f.shared.$f_el;
                        t.hasClass("fr-expanded") && (n = t.findVisible("button:not(.fr-disabled)").first()), n && c(n)
        ...
        function E() {
            if (f.shared.$f_el && (f.events.disableBlur(), f.shared.$f_el.blur(), f.shared.$f_el = null), !1 !== f.events.trigger("toolbar.focusEditor") && (f.events.disableBlur(), f.$el.get(0).focus(), f.events.focus(), f.browser.safari && f.shared.safariSelection)) {
                var e = f.shared.safariSelection,
                    ...
                    o = e.endOffset,
                    i = f.doc.createRange();
                i.setStart(t, r), i.setEnd(n, o), f.selection.get().removeAllRanges(), f.selection.get().addRange(i), f.shared.safariSelection = null
            }
        }
        ...
        function e(e) {
            ...
            var n = f.popups.areVisible(f),
                r = !1;
            return n && (r = u(n.children().not(".fr-buttons"))), r || d(), f.shared.with_kb = !1, e.preventDefault(), e.stopPropagation(), !1
        }
        return {
            _init: function r() {
                f.$wp ? f.events.on("keydown", e, !0) : f.events.$on(f.$win, "keydown", e, !0), f.events.on("mousedown", function(e) {
                    S(f), f.shared.$f_el && f.el.isSameNode(f.shared.$f_el[0]) && (f.accessibility.restoreSelection(), e.stopPropagation(), f.events.disableBlur(), f.shared.$f_el = null)
                }, !0), f.events.on("blur", function() {
                    f.shared.$f_el = null, S(f)
                }, !0)
            },
                    ...
                    p.$tooltip || function f() {
                        if (p.opts.tooltips && !p.helpers.isMobile()) {
                            if (p.shared.$tooltip) p.$tooltip = p.shared.$tooltip;
                                ...
                                var e = {};
                                p.$wp && 0 < p.$wp.length && (e = p.$wp.closest("dialog")), 0 < e.length ? e.first().append(p.$tooltip) : h(p.o_doc).find("body").first().append(p.$tooltip)
                            }
                            p.events.on("shared.destroy", function() {
                                p.$tooltip.html("").removeData().remove(), p.$tooltip = null
                            }, !0)
                        }
                    }(), e.removeAttr("title"), p.$tooltip.text(p.language.translate(e.data("title"))), p.$tooltip.addClass("fr-visible");
                    var l = e.offset().left + (e.outerWidth() - p.$tooltip.outerWidth()) / 2;
                    l < 0 && (l = 0), l + p.$tooltip.outerWidth() > h(p.o_win).width() && (l = h(p.o_win).width() - p.$tooltip.outerWidth()), void 0 === t && (t = p.opts.toolbarBottom), e.offset().top - h(window).scrollTop() + e.outerHeight() + 10 >= h(window).height() && (t = !0);
        ...
        return {
            ...
            bind: function i(e, t, n) {
                ...
                }, !0), p.events.$on(e, "mouseout ".concat(p._mousedown, " ").concat(p._mouseup), t, function() {
                    r()
                }, !0))
            }
        }
        ...
        function t(e) {
            ...
            if (0 === e.parents(".fr-popup").length && e.data("popup") && !e.hasClass("fr-btn-active-popup") && (e.attr("id") === "insertLink-".concat(g.id) && n && n.hasClass("fr-active") || e.addClass("fr-btn-active-popup")), 0 !== e.parents(".fr-popup").length || e.data("popup") || t.popups.hideAll(), t.popups.areVisible() && !t.popups.areVisible(t)) {
        ...
        return {
            ...
            buildGroup: function E(e) {
                ...
                for (var r in e) {
                    ...
                    if (o.buttons) {
                        ...
                        "trackChanges" !== r && (t += '<div class="fr-btn-grp fr-float-'.concat(l, '">').concat(i, "</div>")), e.showMoreButtons && 0 < a.length && (n += '<div class="fr-more-toolbar" data-name="'.concat(r + "-" + g.id, '">').concat(a, "</div>"))
                    }
                }
            ...
            bindCommands: function y(t, e) {
                g.events.bindClick(t, ".fr-command:not(.fr-disabled)", d), g.events.$on(t, "".concat(g._mousedown, " ").concat(g._mouseup, " ").concat(g._move), ".fr-dropdown-menu", p, !0), g.events.$on(t, "".concat(g._mousedown, " ").concat(g._mouseup, " ").concat(g._move), ".fr-dropdown-menu .fr-dropdown-wrapper", h, !0);
                var n = t.get(0).ownerDocument,
                    r = "defaultView" in n ? n.defaultView : n.parentWindow;

                function o(e) {
                    (!e || e.type === g._mouseup && e.target !== u("html").get(0) || "keydown" === e.type && (g.keys.isCharacter(e.which) && !g.keys.ctrlKey(e) || e.which === V.KEYCODE.ESC)) && (f(t), g.opts.iframe && function r(e) {
                ...
                g.events.$on(u(r), "".concat(g._mouseup, " resize keydown"), o, !0), g.opts.iframe && g.events.$on(g.$win, g._mouseup, o, !0), g.node.hasClass(t.get(0), "fr-popup") ? u.merge(s, t.find(".fr-btn").toArray()) : u.merge(a, t.find(".fr-btn").toArray()), g.tooltip.bind(t, ".fr-btn, .fr-title", e)
            },
        ...
        function o() {
            ...
            if (0 === t.top && 0 === t.left && 0 === t.width || 0 === t.height) {
                ...
                var i = o.offset(),
                    a = o.outerHeight();
                o.css("display", "none"), o.css("line-height", 0), (t = {}).left = i && i.left, t.width = 0, t.height = a, t.top = i && i.top - (L.helpers.isMobile() && !L.helpers.isIOS() || L.opts.iframe ? 0 : L.helpers.scrollTop()), t.right = 1, t.bottom = 1, t.ok = !0, n && (r ? L.$el.find(".fr-marker").remove() : L.selection.restore())
            }
            return t
        }
        ...
        return {
            _init: function e() {
                ! function t() {
                    if (L._stickyElements = [], L.helpers.getIOSVersion() <= 8) s(), L.events.$on(E(L.o_win), "scroll", function() {
                        if (L.core.hasFocus())
                            for (var e = 0; e < L._stickyElements.length; e++) {
                        ...
                        "body" !== L.opts.scrollableContainer && L.events.$on(E(L.opts.scrollableContainer), "scroll", n, !0), L.events.$on(E(L.o_win), "scroll", n, !0), L.events.$on(E(L.o_win), "resize", n, !0), L.events.on("initialized", n), L.events.on("focus", n), L.events.$on(E(L.o_win), "resize", "textarea", n, !0);
        ...
        function e(e) {
            ...
            } else "object" !== x(e) || Array.isArray(e) || ((n = e).showMoreButtons = !0);
            return n
        }
        ...
        function o() {
            ...
            if (y !== E.helpers.screenSize(E.opts.toolbarResponsiveToEditor)) {
                ...
                for (var l in E.$tb.find(".fr-btn-grp > .fr-command, .fr-more-toolbar > .fr-command, .fr-btn-grp > .fr-btn-wrap > .fr-command, .fr-more-toolbar > .fr-btn-wrap > .fr-command").addClass("fr-hidden"),
                        ...
                        }(), E.$tb.find(".fr-separator.fr-vs, .fr-separator.fr-hs").remove(), i) {
                    var c = i[l];
        ...
        function n(t, n) {
            setTimeout(function() {
                ...
                if ((!t || t.which != V.KEYCODE.ESC) && E.selection.inEditor() && E.core.hasFocus() && !E.popups.areVisible() && "false" != S(E.selection.blocks()[0]).closest("table").attr("contenteditable") && "INPUT" !== e.tagName && "TEXTAREA" !== e.tagName && (E.opts.toolbarVisibleWithoutSelection || !E.selection.isCollapsed() && !E.keys.isIME() || n)) {
                    if (E.$tb.data("instance", E), !1 === E.events.trigger("toolbar.show", [t])) return;
        ...
        function s() {
            E.events.on("window.mousedown", i), E.events.on("keydown", i), E.events.on("blur", i), E.events.$on(E.$tb, "transitionend", ".fr-more-toolbar", function() {
        ...
        function d() {
            E.opts.theme && E.$tb.addClass("".concat(E.opts.theme, "-theme")), 1 < E.opts.zIndex && E.$tb.css("z-index", E.opts.zIndex + 1), "auto" !== E.opts.direction && E.$tb.removeClass("fr-ltr fr-rtl").addClass("fr-".concat(E.opts.direction)), E.helpers.isMobile() ? E.$tb.addClass("fr-mobile") : E.$tb.addClass("fr-desktop"), E.opts.toolbarContainer ? (E.opts.toolbarInline && (s(), i()), E.opts.toolbarBottom ? E.$tb.addClass("fr-bottom") : E.$tb.addClass("fr-top")) : function e() {
    ...
    var c = ["scroll", "wheel", "touchmove", "touchstart", "touchend"],
        ...
        u = function u(n, r) {
            return function(e) {
                var t = e.target;
                if (r)
                    for (r = C(r); t && t !== this;) Element.prototype.matches.call(t, C(r)) && n.call(t, p(e, t)), t = t.parentNode;
                else h(t) && n.call(t, p(e, t))
            }
        },
        g = function g(e, t) {
            return new b(e, t)
    ...
    g.fn = g.prototype = {
        ...
        wrapAll: function(e) {
            var t;
            return this[0] && (m(e) && (e = e.call(this[0])), t = g(e, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && t.insertBefore(this[0]), t.map(function() {
        ...
        wrapContent: function(e) {
            for (var t = document.createElement(e.tagName), n = 0; n < e.attributes.length; n++) v(t).attr(e.attributes[n].nodeName, e.attributes[n].value);
            v(this[0]).contents().wrapAll(t)
        },
        wrap: function(t) {
            var n = m(t);
        ...
        find: function(e) {
            ...
            var o = function o(e) {
                return "object" === ("undefined" == typeof HTMLElement ? "undefined" : x(HTMLElement)) ? e instanceof HTMLElement : e && "object" === x(e) && null !== e && 1 === e.nodeType && "string" == typeof e.nodeName
            };
            e = C(e);
    ...
    function y() {
        this.doc = this.$el.get(0).ownerDocument, this.win = "defaultView" in this.doc ? this.doc.defaultView : this.doc.parentWindow, this.$doc = g(this.doc), this.$win = g(this.win), this.opts.pluginsEnabled || (this.opts.pluginsEnabled = Object.keys(L.PLUGINS)), this.opts.initOnClick ? (this.load(L.MODULES), this.$el.on("touchstart.init", function() {
            ...
            if ("false" !== this.$el.attr("contentEditable") || !this.opts.initOnClick) {
                ...
                if (1 === e.which || !e.which) {
                    this.$el.off("mousedown.init touchstart.init touchmove.init touchend.init dragenter.init focus.init"), this.load(L.MODULES), this.load(L.PLUGINS);
        ...
        }.bind(this)), this.events.trigger("initializationDelayed")) : (this.load(L.MODULES), this.load(L.PLUGINS), g(this.o_win).scrollTop(this.c_scroll), "undefined" == typeof this.ul && this.destroy(), this.ready = !0, this.events.trigger("initialized"))
    }
    return L.Bootstrap = function(e, t, n) {
        this.id = ++L.ID, this.$ = g;
        var r = {};
        ...
        ], r.paragraphFormatSelection = !0, r.fontFamilySelection = !0, r.fontSizeSelection = !0, r.placeholderText = "", r.quickInsertEnabled = !1, r.charCounterCount = !1), this.opts = Object.assign({}, Object.assign({}, L.DEFAULTS, r, "object" === x(t) && t));
        var o = JSON.stringify(this.opts);
        L.OPTS_MAPPING[o] = L.OPTS_MAPPING[o] || this.id, this.sid = L.OPTS_MAPPING[o], L.SHARED[this.sid] = L.SHARED[this.sid] || {}, this.shared = L.SHARED[this.sid], this.shared.count = (this.shared.count || 0) + 1, this.$oel = g(e), this.$oel.data("froala.editor", this), this.o_doc = e.ownerDocument, this.o_win = "defaultView" in this.o_doc ? this.o_doc.defaultView : this.o_doc.parentWindow, this.c_scroll = g(this.o_win).scrollTop(), this._init()
    }, L.Bootstrap.prototype._init = function() {
        ...
        var t = function() {
            ...
            r = function() {
                this.$el = this.$oel, this.el = this.$el.get(0), this.$el.attr("contenteditable", !0).css("outline", "none").css("display", "inline-block"), this.opts.multiLine = !1, this.opts.toolbarInline = !1, setTimeout(y.bind(this), 0)
            }.bind(this),
            o = function() {
                this.$el = this.$oel, this.el = this.$el.get(0), this.opts.toolbarInline = !1, setTimeout(y.bind(this), 0)
            }.bind(this),
            i = function() {
                this.$el = this.$oel, this.el = this.$el.get(0), this.opts.toolbarInline = !1, this.$oel.on("click.popup", function(e) {
                    e.preventDefault()
                }), setTimeout(y.bind(this), 0)
            }.bind(this);
    ...
    }, L.Bootstrap.prototype.load = function(e) {
        for (var t in e)
            if (Object.prototype.hasOwnProperty.call(e, t)) {
                if (this[t]) continue;
                if (L.PLUGINS[t] && this.opts.pluginsEnabled.indexOf(t) < 0) continue;
                if (this[t] = new e[t](this), this[t]._init && (this[t]._init(), this.opts.initOnClick && "core" === t)) return !1
            }
    }, L.Bootstrap.prototype.destroy = function() {
        ...
        if (this.opts.iframe && (this.events.disableBlur(), this.win.focus(), this.events.enableBlur()), this.events && (this.events.trigger("destroy", [], !0), this.events.trigger("shared.destroy", [], !0)), 0 === this.shared.count) {
            for (var t in this.shared) Object.prototype.hasOwnProperty.call(this.shared, t) && (this.shared[t] = null, L.SHARED[this.sid][t] = null);
            delete L.SHARED[this.sid]
        }
        this.$oel.parents("form").off(".".concat(this.id)), this.$oel.off("click.popup"), this.$oel.removeData("froala.editor"), this.$oel.off("froalaEditor"), this.core && this.core.destroy(e), L.INSTANCES.splice(L.INSTANCES.indexOf(this), 1)
    }, V
});