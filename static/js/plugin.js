...
------------------------------------------------
    ...
    @version         : 1.0.0
    @Template Name   : login
    @Template author : harverstofhope
...
! function(e, t, n) {
    ...
    a.prototype.init = function() {
        ...
        if (r.duplicate ? i.mobileNav = s.clone() : i.mobileNav = s, r.removeIds && (i.mobileNav.removeAttr("id"), i.mobileNav.find("*").each(function(t, n) {
            ...
            })), n = o + "_icon", "" === r.label && (n += " " + o + "_no-text"), "a" == r.parentTag && (r.parentTag = 'a href="javascript:void(0)"'), i.mobileNav.attr("class", o + "_nav"), a = e('<div class="' + o + '_menu"></div>'), "" !== r.brand) {
