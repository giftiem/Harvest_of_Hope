/*! Pickr 1.9.1 MIT | https://github.com/Simonwep/pickr */ ! function(t, e) {
    ...
    var t = {
            ...
            7022: (t, e, r) => {
                ...
                t.exports = function(t) {
                    ...
                    var y, b, m, x, w, S, _ = f(e),
                        A = 0;
                    if (!_ || this === v && c(_))
                        for (y = s(e), b = r ? new this(y) : v(y); y > A; A++) S = g ? d(e[A], A) : e[A], l(b, A, S);
                    else
                        for (b = r ? new this : [], w = (x = p(e, _)).next; !(m = o(w, x)).done; A++) S = g ? a(x, d, [m.value, A], !0) : m.value, l(b, A, S);
                    return b.length = A, b
                }
            },
            1675: (t, e, r) => {
                ...
                var n = r(3122),
                    ...
                    l = function(t) {
                        ...
                        return function(h, d, g, y) {
                            for (var b, m, x = a(h), w = i(x), S = c(w), _ = n(d, g), A = 0, O = y || u, E = e ? O(h, S) : r || f ? O(h, 0) : void 0; S > A; A++)
            ...
            654: (t, e, r) => {
                ...
                t.exports = function(t, e, r, a, h, g, E) {
                    ...
                    if (N && (j = s(N.call(new t))) !== Object.prototype && j.next && (i || s(j) === m || (l ? l(j, m) : c(j[w]) || v(j, w, O)), p(j, I, !0, !0), i && (d[I] = O)), y && h === _ && L && L.name !== _ && (!i && b ? f(T, "name", _) : (R = !0, F = function() {
                            return o(L, this)
                        })), h)
                        if (C = {
                                values: P(_),
            ...
            1601: (t, e, r) => {
                ...
                (S || A || _ || v || h) && (y = function(t) {
                    var e, r, n, o, a, s, l, v = this,
                        ...
                        O = c(t),
                        E = h.raw;
                    if (E) return E.lastIndex = v.lastIndex, e = i(y, E, O), v.lastIndex = E.lastIndex, e;
                    var j = h.groups,
                        C = _ && v.sticky,
                        k = i(u, v),
                        P = v.source,
                        I = 0,
                        R = O;
                    if (C && (k = x(k, "y", ""), -1 === m(k, "g") && (k += "g"), R = w(O, v.lastIndex), v.lastIndex > 0 && (!v.multiline || v.multiline && "\n" !== b(O, v.lastIndex - 1)) && (P = "(?: " + P + ")", R = " " + R, I++), r = new RegExp("^(?:" + P + ")", k)), A && (r = new RegExp("^" + P + "$(?!\\s)", k)), S && (n = v.lastIndex), o = i(g, C ? r : v, R), C ? o ? (o.input = w(o.input, I), o[0] = w(o[0], I), o.index = v.lastIndex, v.lastIndex += o[0].length) : v.lastIndex = 0 : S && o && (v.lastIndex = v.global ? o.index + o[0].length : n), A && o && o.length > 1 && i(d, o[0], r, (function() {
            ...
            4318: (t, e, r) => {
                ...
                P.prototype = A, k && !o && (A.constructor = P), n({
                    global: !0,
                    constructor: !0,
                    wrap: !0,
                    forced: k
            ...
            5746: (t, e, r) => {
                ...
                n({
                    ...
                    toFixed: function(t) {
                        ...
                        return m = u > 0 ? h + ((o = m.length) <= u ? "0." + f("0", u - o) + m : v(m, 0, o - u) + "." + v(m, o - u)) : h + m
                    }
                })
            },
            7591: (t, e, r) => {
                ...
                i("split", (function(t, e, r) {
                    ...
                    return [function(e, r) {
                        ...
                        for (var A = 0, O = 0, E = []; O < c.length;) {
                            w.lastIndex = y ? 0 : O;
                            var j, C = h(w, y ? x(c, O) : c);
                            if (null === C || (j = b(p(w.lastIndex + (y ? O : 0)), c.length)) === A) O = l(c, O, d);
                            else {
            ...
            2528: (t, e, r) => {
                ...
                s || (j(Y = (z = function() {
                    ...
                    return ut(R(t), t)
                })), E.f = pt, A.f = st, O.f = lt, _.f = ft, x.f = w.f = vt, S.f = ht, L.f = function(t) {
                    return ut(T(t), t)
                }, u && (C(Y, "description", {
                    configurable: !0,
                    get: function() {
    ...
    return (() => {
                ...
                if (e = r[o].exec(t)) switch (o) {
                    ...
                    case "hsla":
                        var S = n(e),
                            ...
                            O = S[3],
                            E = S[5];
                        if (E = "%" === e[6] ? E / 100 : E, _ > 360 || A > 100 || O > 100 || E < 0 || E > 1) break t;
                        return {
                    ...
                    _keyboard: function(t) {
                        ...
                        if (document.activeElement === r.wrapper) {
                            ...
                            if ("keydown" === n && (a || c || u || s)) {
                                var l = 0,
                                    p = 0;
                                "v" === i ? l = a || c ? 1 : -1 : "h" === i ? l = a || c ? -1 : 1 : (p = a ? -1 : u ? 1 : 0, l = s ? -1 : c ? 1 : 0), e.update(A(e.cache.x + .01 * l), A(e.cache.y + .01 * p)), t.preventDefault()
        ...
        var R = function() {
            function e(t) {
                var r = this;
                this._initializingActive = !0, this._recalc = !0, this._nanopop = null, this._root = null, this._color = _(), this._lastColor = _(), this._swatchColors = [], this._setupAnimationFrame = null, this._eventListener = {
                    init: [],
                    save: [],
                    hide: [],
                    show: [],
            ...
            return r._preBuild = function() {
                ...
                this._root = (e = (t = this).options, r = e.components, n = e.useAsButton, o = e.inline, i = e.appClass, a = e.theme, c = e.lockOpacity, u = function(t) {
                        ...
                        palette: O({
                            ...
                            onchange: function(t, n) {
                                if (r.palette) {
                                    ...
                                    for (var f, v = o.toHEXA().toString(), h = P(e._swatchColors); !(f = h()).done;) {
                                        var d = f.value,
                                            g = d.el,
                                            y = d.color;
        ...
        k = R, R.utils = t, R.version = "1.9.1", R.I18N_DEFAULTS = {
